# spatie/yii-ray - Send debug output from Yii2 to Ray
...
This package can be installed in any Yii2 application to send debug output to [Ray](https://myray.app), the desktop debugging app from [Spatie](https://spatie.be/). 

[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/yii-ray.jpg?t=1769610085" width="500px" />](https://spatie.be/github-ad-click/yii-ray)
...
You can find the full documentation for using Ray with Yii2 on [https://myray.app/docs/php/yii](https://myray.app/docs/php/yii/getting-started).
